...
export class ObservableReadApi {
    private requestFactory: ReadApiRequestFactory;
    private responseProcessor: ReadApiResponseProcessor;
    private configuration: Configuration;
    ...
    public constructor(
        ...
        this.configuration = configuration;
        this.requestFactory = requestFactory || new ReadApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new ReadApiResponseProcessor();
    }
     ...
     * @param max_depth 
     */
    public getCheck(namespace?: string, object?: string, relation?: string, subject_id?: string, subject_set_namespace?: string, subject_set_object?: string, subject_set_relation?: string, max_depth?: number, _options?: Configuration): Observable<GetCheckResponse> {
        const requestContextPromise = this.requestFactory.getCheck(namespace, object, relation, subject_id, subject_set_namespace, subject_set_object, subject_set_relation, max_depth, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getCheck(rsp)));
            }));
    }
     ...
     * Check a relation tuple
     */
    public getCheckMirrorStatus(_options?: Configuration): Observable<GetCheckResponse> {
        const requestContextPromise = this.requestFactory.getCheckMirrorStatus(_options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getCheckMirrorStatus(rsp)));
            }));
    }
     ...
     * @param max_depth 
     */
    public getExpand(namespace: string, object: string, relation: string, max_depth?: number, _options?: Configuration): Observable<ExpandTree> {
        const requestContextPromise = this.requestFactory.getExpand(namespace, object, relation, max_depth, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getExpand(rsp)));
            }));
    }
     ...
     * @param subject_set_relation Relation of the Subject Set
     */
    public getRelationTuples(page_token?: string, page_size?: number, namespace?: string, object?: string, relation?: string, subject_id?: string, subject_set_namespace?: string, subject_set_object?: string, subject_set_relation?: string, _options?: Configuration): Observable<GetRelationTuplesResponse> {
        const requestContextPromise = this.requestFactory.getRelationTuples(page_token, page_size, namespace, object, relation, subject_id, subject_set_namespace, subject_set_object, subject_set_relation, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getRelationTuples(rsp)));
            }));
    }
     ...
     * @param RelationQuery 
     */
    public postCheck(max_depth?: number, RelationQuery?: RelationQuery, _options?: Configuration): Observable<GetCheckResponse> {
        const requestContextPromise = this.requestFactory.postCheck(max_depth, RelationQuery, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.postCheck(rsp)));
            }));
    }
     ...
     * Check a relation tuple
     */
    public postCheckMirrorStatus(_options?: Configuration): Observable<GetCheckResponse> {
        const requestContextPromise = this.requestFactory.postCheckMirrorStatus(_options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.postCheckMirrorStatus(rsp)));
            }));
    }
...
export class ObservableV0alpha2Api {
    private requestFactory: V0alpha2ApiRequestFactory;
    private responseProcessor: V0alpha2ApiResponseProcessor;
    private configuration: Configuration;
    ...
    public constructor(
        ...
        this.configuration = configuration;
        this.requestFactory = requestFactory || new V0alpha2ApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new V0alpha2ApiResponseProcessor();
    }
     ...
     */
    public adminCreateIdentity(AdminCreateIdentityBody?: AdminCreateIdentityBody, _options?: Configuration): Observable<Identity> {
        const requestContextPromise = this.requestFactory.adminCreateIdentity(AdminCreateIdentityBody, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.adminCreateIdentity(rsp)));
            }));
    }
     ...
     */
    public adminCreateSelfServiceRecoveryLink(AdminCreateSelfServiceRecoveryLinkBody?: AdminCreateSelfServiceRecoveryLinkBody, _options?: Configuration): Observable<SelfServiceRecoveryLink> {
        const requestContextPromise = this.requestFactory.adminCreateSelfServiceRecoveryLink(AdminCreateSelfServiceRecoveryLinkBody, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.adminCreateSelfServiceRecoveryLink(rsp)));
            }));
    }
     ...
     */
    public adminDeleteIdentity(id: string, _options?: Configuration): Observable<void> {
     ...
     * @param id ID is the identity&#39;s ID.
     */
    public adminDeleteIdentitySessions(id: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.adminDeleteIdentitySessions(id, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.adminDeleteIdentitySessions(rsp)));
            }));
    }
     ...
     */
    public adminExtendSession(id: string, _options?: Configuration): Observable<Session> {
        const requestContextPromise = this.requestFactory.adminExtendSession(id, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.adminExtendSession(rsp)));
            }));
    }
     ...
     */
    public adminGetIdentity(id: string, include_credential?: Array<string>, _options?: Configuration): Observable<Identity> {
        const requestContextPromise = this.requestFactory.adminGetIdentity(id, include_credential, _options);
     ...
     */
    public adminListIdentities(per_page?: number, page?: number, _options?: Configuration): Observable<Array<Identity>> {
        const requestContextPromise = this.requestFactory.adminListIdentities(per_page, page, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.adminListIdentities(rsp)));
            }));
    }
     ...
     */
    public adminListIdentitySessions(id: string, per_page?: number, page?: number, active?: boolean, _options?: Configuration): Observable<Array<Session>> {
        const requestContextPromise = this.requestFactory.adminListIdentitySessions(id, per_page, page, active, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.adminListIdentitySessions(rsp)));
            }));
    }
     ...
     */
    public adminUpdateIdentity(id: string, AdminUpdateIdentityBody?: AdminUpdateIdentityBody, _options?: Configuration): Observable<Identity> {
        const requestContextPromise = this.requestFactory.adminUpdateIdentity(id, AdminUpdateIdentityBody, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.adminUpdateIdentity(rsp)));
            }));
    }
     ...
     */
    public createSelfServiceLogoutFlowUrlForBrowsers(cookie?: string, _options?: Configuration): Observable<SelfServiceLogoutUrl> {
        const requestContextPromise = this.requestFactory.createSelfServiceLogoutFlowUrlForBrowsers(cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.createSelfServiceLogoutFlowUrlForBrowsers(rsp)));
            }));
    }
     ...
     */
    public getJsonSchema(id: string, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.getJsonSchema(id, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getJsonSchema(rsp)));
            }));
    }
     ...
     */
    public getProject(project_id: string, _options?: Configuration): Observable<Project> {
        const requestContextPromise = this.requestFactory.getProject(project_id, _options);
     ...
     * @param project_id Project ID  The project&#39;s ID.
     */
    public getProjectMembers(project_id: string, _options?: Configuration): Observable<Array<CloudAccount>> {
        const requestContextPromise = this.requestFactory.getProjectMembers(project_id, _options);
     ...
     */
    public getSelfServiceError(id: string, _options?: Configuration): Observable<SelfServiceError> {
        const requestContextPromise = this.requestFactory.getSelfServiceError(id, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getSelfServiceError(rsp)));
            }));
    }
     ...
     */
    public getSelfServiceLoginFlow(id: string, Cookie?: string, _options?: Configuration): Observable<SelfServiceLoginFlow> {
        const requestContextPromise = this.requestFactory.getSelfServiceLoginFlow(id, Cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getSelfServiceLoginFlow(rsp)));
            }));
    }
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public getSelfServiceRecoveryFlow(id: string, Cookie?: string, _options?: Configuration): Observable<SelfServiceRecoveryFlow> {
        const requestContextPromise = this.requestFactory.getSelfServiceRecoveryFlow(id, Cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getSelfServiceRecoveryFlow(rsp)));
            }));
    }
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public getSelfServiceRegistrationFlow(id: string, Cookie?: string, _options?: Configuration): Observable<SelfServiceRegistrationFlow> {
        const requestContextPromise = this.requestFactory.getSelfServiceRegistrationFlow(id, Cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getSelfServiceRegistrationFlow(rsp)));
            }));
    }
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public getSelfServiceSettingsFlow(id: string, X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<SelfServiceSettingsFlow> {
        const requestContextPromise = this.requestFactory.getSelfServiceSettingsFlow(id, X_Session_Token, Cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getSelfServiceSettingsFlow(rsp)));
            }));
    }
     ...
     */
    public getSelfServiceVerificationFlow(id: string, cookie?: string, _options?: Configuration): Observable<SelfServiceVerificationFlow> {
        const requestContextPromise = this.requestFactory.getSelfServiceVerificationFlow(id, cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getSelfServiceVerificationFlow(rsp)));
            }));
    }
     ...
     */
    public initializeSelfServiceLoginFlowForBrowsers(refresh?: boolean, aal?: string, return_to?: string, _options?: Configuration): Observable<SelfServiceLoginFlow> {
        const requestContextPromise = this.requestFactory.initializeSelfServiceLoginFlowForBrowsers(refresh, aal, return_to, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.initializeSelfServiceLoginFlowForBrowsers(rsp)));
            }));
    }
     ...
     */
    public initializeSelfServiceLoginFlowWithoutBrowser(refresh?: boolean, aal?: string, X_Session_Token?: string, _options?: Configuration): Observable<SelfServiceLoginFlow> {
        const requestContextPromise = this.requestFactory.initializeSelfServiceLoginFlowWithoutBrowser(refresh, aal, X_Session_Token, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.initializeSelfServiceLoginFlowWithoutBrowser(rsp)));
            }));
    }
     ...
     * @param return_to The URL to return the browser to after the flow was completed.
     */
    public initializeSelfServiceRecoveryFlowForBrowsers(return_to?: string, _options?: Configuration): Observable<SelfServiceRecoveryFlow> {
        const requestContextPromise = this.requestFactory.initializeSelfServiceRecoveryFlowForBrowsers(return_to, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.initializeSelfServiceRecoveryFlowForBrowsers(rsp)));
            }));
    }
     ...
     */
    public initializeSelfServiceRecoveryFlowWithoutBrowser(_options?: Configuration): Observable<SelfServiceRecoveryFlow> {
        const requestContextPromise = this.requestFactory.initializeSelfServiceRecoveryFlowWithoutBrowser(_options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.initializeSelfServiceRecoveryFlowWithoutBrowser(rsp)));
            }));
    }
     ...
     * @param return_to The URL to return the browser to after the flow was completed.
     */
    public initializeSelfServiceRegistrationFlowForBrowsers(return_to?: string, _options?: Configuration): Observable<SelfServiceRegistrationFlow> {
        const requestContextPromise = this.requestFactory.initializeSelfServiceRegistrationFlowForBrowsers(return_to, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.initializeSelfServiceRegistrationFlowForBrowsers(rsp)));
            }));
    }
     ...
     */
    public initializeSelfServiceRegistrationFlowWithoutBrowser(_options?: Configuration): Observable<SelfServiceRegistrationFlow> {
        const requestContextPromise = this.requestFactory.initializeSelfServiceRegistrationFlowWithoutBrowser(_options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.initializeSelfServiceRegistrationFlowWithoutBrowser(rsp)));
            }));
    }
     ...
     * @param return_to The URL to return the browser to after the flow was completed.
     */
    public initializeSelfServiceSettingsFlowForBrowsers(return_to?: string, _options?: Configuration): Observable<SelfServiceSettingsFlow> {
        const requestContextPromise = this.requestFactory.initializeSelfServiceSettingsFlowForBrowsers(return_to, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.initializeSelfServiceSettingsFlowForBrowsers(rsp)));
            }));
    }
     ...
     * @param X_Session_Token The Session Token of the Identity performing the settings flow.
     */
    public initializeSelfServiceSettingsFlowWithoutBrowser(X_Session_Token?: string, _options?: Configuration): Observable<SelfServiceSettingsFlow> {
        const requestContextPromise = this.requestFactory.initializeSelfServiceSettingsFlowWithoutBrowser(X_Session_Token, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.initializeSelfServiceSettingsFlowWithoutBrowser(rsp)));
            }));
    }
     ...
     * @param return_to The URL to return the browser to after the flow was completed.
     */
    public initializeSelfServiceVerificationFlowForBrowsers(return_to?: string, _options?: Configuration): Observable<SelfServiceVerificationFlow> {
        const requestContextPromise = this.requestFactory.initializeSelfServiceVerificationFlowForBrowsers(return_to, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.initializeSelfServiceVerificationFlowForBrowsers(rsp)));
            }));
    }
     ...
     */
    public initializeSelfServiceVerificationFlowWithoutBrowser(_options?: Configuration): Observable<SelfServiceVerificationFlow> {
        const requestContextPromise = this.requestFactory.initializeSelfServiceVerificationFlowWithoutBrowser(_options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.initializeSelfServiceVerificationFlowWithoutBrowser(rsp)));
            }));
    }
     ...
     * @param page Pagination Page
     */
    public listIdentitySchemas(per_page?: number, page?: number, _options?: Configuration): Observable<Array<IdentitySchema>> {
     ...
     * @param page Pagination Page
     */
    public listSessions(X_Session_Token?: string, Cookie?: string, per_page?: number, page?: number, _options?: Configuration): Observable<Array<Session>> {
        const requestContextPromise = this.requestFactory.listSessions(X_Session_Token, Cookie, per_page, page, _options);
     ...
     * @param JsonPatch 
     */
    public patchProject(project_id: string, JsonPatch?: Array<JsonPatch>, _options?: Configuration): Observable<SuccessfulProjectUpdate> {
        const requestContextPromise = this.requestFactory.patchProject(project_id, JsonPatch, _options);
     ...
     * @param project_id Project ID  The project&#39;s ID.
     */
    public purgeProject(project_id: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.purgeProject(project_id, _options);
     ...
     */
    public removeProjectMember(project_id: string, member_id: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.removeProjectMember(project_id, member_id, _options);
     ...
     * @param id ID is the session&#39;s ID.
     */
    public revokeSession(id: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.revokeSession(id, _options);
     ...
     * @param Cookie Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: &#x60;ory_kratos_session&#x3D;a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f&#x3D;&#x3D;&#x60;.  It is ok if more than one cookie are included here as all other cookies will be ignored.
     */
    public revokeSessions(X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<RevokedSessions> {
        const requestContextPromise = this.requestFactory.revokeSessions(X_Session_Token, Cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.revokeSessions(rsp)));
            }));
    }
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public submitSelfServiceLoginFlow(flow: string, SubmitSelfServiceLoginFlowBody: SubmitSelfServiceLoginFlowBody, X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<SuccessfulSelfServiceLoginWithoutBrowser> {
        const requestContextPromise = this.requestFactory.submitSelfServiceLoginFlow(flow, SubmitSelfServiceLoginFlowBody, X_Session_Token, Cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.submitSelfServiceLoginFlow(rsp)));
            }));
    }
     ...
     */
    public submitSelfServiceLogoutFlow(token?: string, return_to?: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.submitSelfServiceLogoutFlow(token, return_to, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.submitSelfServiceLogoutFlow(rsp)));
            }));
    }
     ...
     */
    public submitSelfServiceLogoutFlowWithoutBrowser(SubmitSelfServiceLogoutFlowWithoutBrowserBody: SubmitSelfServiceLogoutFlowWithoutBrowserBody, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.submitSelfServiceLogoutFlowWithoutBrowser(SubmitSelfServiceLogoutFlowWithoutBrowserBody, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.submitSelfServiceLogoutFlowWithoutBrowser(rsp)));
            }));
    }
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public submitSelfServiceRecoveryFlow(flow: string, SubmitSelfServiceRecoveryFlowBody: SubmitSelfServiceRecoveryFlowBody, token?: string, Cookie?: string, _options?: Configuration): Observable<SelfServiceRecoveryFlow> {
        const requestContextPromise = this.requestFactory.submitSelfServiceRecoveryFlow(flow, SubmitSelfServiceRecoveryFlowBody, token, Cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.submitSelfServiceRecoveryFlow(rsp)));
            }));
    }
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public submitSelfServiceRegistrationFlow(flow: string, SubmitSelfServiceRegistrationFlowBody: SubmitSelfServiceRegistrationFlowBody, Cookie?: string, _options?: Configuration): Observable<SuccessfulSelfServiceRegistrationWithoutBrowser> {
        const requestContextPromise = this.requestFactory.submitSelfServiceRegistrationFlow(flow, SubmitSelfServiceRegistrationFlowBody, Cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.submitSelfServiceRegistrationFlow(rsp)));
            }));
    }
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public submitSelfServiceSettingsFlow(flow: string, SubmitSelfServiceSettingsFlowBody: SubmitSelfServiceSettingsFlowBody, X_Session_Token?: string, Cookie?: string, _options?: Configuration): Observable<SelfServiceSettingsFlow> {
        const requestContextPromise = this.requestFactory.submitSelfServiceSettingsFlow(flow, SubmitSelfServiceSettingsFlowBody, X_Session_Token, Cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.submitSelfServiceSettingsFlow(rsp)));
            }));
    }
     ...
     * @param Cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    public submitSelfServiceVerificationFlow(flow: string, SubmitSelfServiceVerificationFlowBody: SubmitSelfServiceVerificationFlowBody, token?: string, Cookie?: string, _options?: Configuration): Observable<SelfServiceVerificationFlow> {
        const requestContextPromise = this.requestFactory.submitSelfServiceVerificationFlow(flow, SubmitSelfServiceVerificationFlowBody, token, Cookie, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.submitSelfServiceVerificationFlow(rsp)));
            }));
    }
     ...
     * @param UpdateProject 
     */
    public updateProject(project_id: string, UpdateProject?: UpdateProject, _options?: Configuration): Observable<SuccessfulProjectUpdate> {
        const requestContextPromise = this.requestFactory.updateProject(project_id, UpdateProject, _options);
...
export class ObservableWriteApi {
    private requestFactory: WriteApiRequestFactory;
    private responseProcessor: WriteApiResponseProcessor;
    private configuration: Configuration;
    ...
    public constructor(
        ...
        this.configuration = configuration;
        this.requestFactory = requestFactory || new WriteApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new WriteApiResponseProcessor();
    }
     ...
     * @param RelationQuery 
     */
    public createRelationTuple(RelationQuery?: RelationQuery, _options?: Configuration): Observable<RelationQuery> {
        const requestContextPromise = this.requestFactory.createRelationTuple(RelationQuery, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.createRelationTuple(rsp)));
            }));
    }
     ...
     * @param subject_set_relation Relation of the Subject Set
     */
    public deleteRelationTuples(namespace?: string, object?: string, relation?: string, subject_id?: string, subject_set_namespace?: string, subject_set_object?: string, subject_set_relation?: string, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteRelationTuples(namespace, object, relation, subject_id, subject_set_namespace, subject_set_object, subject_set_relation, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.deleteRelationTuples(rsp)));
            }));
    }
     ...
     * @param PatchDelta 
     */
    public patchRelationTuples(PatchDelta?: Array<PatchDelta>, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.patchRelationTuples(PatchDelta, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.patchRelationTuples(rsp)));
            }));
    }
